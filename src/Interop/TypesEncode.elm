...
encodePage a = object [ ( "siteTitle", string a.siteTitle ), ( "pageFileName", string a.pageFileName ), ( "layout", string a.layout ), ( "mtime", string a.mtime ), ( "excerpt", string a.excerpt ), ( "markdown", string a.markdown ), ( "data", string a.data ), ( "data2", string a.data2 ) ]
