...
decodePage = (map8 (\a b c d e f g h -> { siteTitle = a, pageFileName = b, layout = c, mtime = d, excerpt = e, markdown = f, data = g, data2 = h }) (field "siteTitle" (string)) (field "pageFileName" (string)) (field "layout" (string)) (field "mtime" (string)) (field "excerpt" (string)) (field "markdown" (string)) (field "data" (string)) (field "data2" (string)))
